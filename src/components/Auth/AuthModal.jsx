            ...
            <form onSubmit={handleLoginSubmit} className="space-y-4">
              ...
              <div className="pt-2">
                <button
                  ...
                  disabled={isLoading}
                  className="w-full py-2.5 px-3 rounded-xl border border-dashed border-brand-teal/30 bg-brand-teal/5 hover:bg-brand-teal/10 text-brand-teal text-xs font-bold flex items-center justify-center gap-2 transition-colors cursor-pointer"
                >
                  <Sparkles size={14} className="text-brand-ochre" />
                  <span>One-Click Student Demo Login (Ritesh Yadav)</span>
                </button>
              </div>
