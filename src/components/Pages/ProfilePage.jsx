...
export default function ProfilePage({ onNavigate, initialTab = 'profile' }) {
  ...
  const [activeTab, setActiveTab] = useState(initialTab); // 'profile' | 'wishlist' | 'orders' | 'cart' | 'addresses'
      ...
      <div className="container mx-auto px-4 mt-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-3">
            <div className="bg-white border border-gray-200 rounded-2xl p-3 sm:p-4 shadow-xs space-y-1.5 sticky top-[90px]">
              <button
