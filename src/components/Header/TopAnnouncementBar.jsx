...
export default function TopAnnouncementBar() {
  return (
    <div className="bg-brand-teal text-white/85 text-xs font-medium py-1.5 border-b border-white/10">
      <div className="container mx-auto px-4 flex items-center justify-between gap-4 flex-wrap">
        ...
        <div className="hidden sm:inline-flex items-center gap-1.5 text-white/80 hover:text-brand-yellow transition-colors">
          ...
          <span>10% OFF Your First Order | Use Code: <strong className="text-brand-yellow font-bold">SCHOOL10</strong></span>
        </div>
