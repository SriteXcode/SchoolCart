...
export default function ProductDetailModal() {
  ...
  }, [selectedProduct, closeProductDetails]);
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-5 bg-black/65 backdrop-blur-xs animate-fadeIn"
      onClick={closeProductDetails}
    >
      <div
        ref={scrollRef}
        className="relative w-full max-w-4xl bg-white rounded-3xl shadow-2xl overflow-y-auto max-h-[92vh] border border-gray-100 flex flex-col"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Sticky Header Bar */}
        <div className="sticky top-0 z-20 bg-white/95 backdrop-blur-md px-6 py-3.5 border-b border-gray-100 flex items-center justify-between">
        ...
        <div className="p-6 sm:p-8">
          ...
          {/* =========================================================
              MORE PRODUCT RECOMMENDATIONS ("YOU MAY ALSO LIKE")
              ========================================================= */}
